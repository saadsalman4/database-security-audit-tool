...
import SqlAuditForm from '../components/forms/SqlAuditForm';
      ...
      <Container>
        <div className="mb-8">
          <div className="inline-flex items-center justify-center p-2 bg-sql-light rounded-lg mb-4">
            ...
            <span className="ml-2 text-sql-primary font-medium">SQL Database Security Audit</span>
          </div>
          <h1 className="text-3xl font-bold text-gray-900">SQL Database Security Audit</h1>
          <p className="mt-2 text-lg text-gray-600">
            Scan your SQL database for security vulnerabilities, configuration issues, and best practice violations.
          </p>
        </div>
        ...
        {auditResults ? (
          ...
          >
            ...
            <Card className="p-6" theme="sql">
              <h2 className="text-xl font-semibold text-gray-900 mb-6">Audit Results</h2>
              <AuditResults results={auditResults.results} theme="sql" />
            </Card>
          </motion.div>
        ) : (
          <motion.div
          ...
          >
            <Card className="p-6" theme="sql">
              <h2 className="text-xl font-semibold text-gray-900 mb-6">Connect to SQL Database</h2>
              ...
              <SqlAuditForm onAuditComplete={handleAuditComplete} onAuditError={handleAuditError} />
            </Card>
